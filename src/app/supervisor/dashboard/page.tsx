...
const kpiData = [
  {
    title: 'Arrecadação da Supervisão',
    value: 'R$ 8.750,20',
    change: '+12.5% em relação ao mês passado',
    icon: DollarSign,
  },
  {
    title: 'Membros Ativos na Supervisão',
    value: '310',
    change: '+45 este mês',
    icon: Users,
  },
  {
    title: 'Igrejas na Supervisão',
    value: '5',
    change: '+1 este mês',
    icon: Church,
  },
  {
    title: 'Pastores na Supervisão',
    value: '7',
    change: '+1 este mês',
    icon: User,
  },
...
const churchesData = [
  { id: 'chu-01', name: 'Comunidade da Graça', monthlyRevenue: 2800.50, members: 95, fill: '#3b82f6' },
  { id: 'chu-02', name: 'Videira', monthlyRevenue: 4100.00, members: 150, fill: '#f97316' },
  { id: 'chu-03', name: 'Fonte da Vida', monthlyRevenue: 1850.00, members: 65, fill: '#ef4444' },
];
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
        <Card>
            <CardHeader>
                <CardTitle>Arrecadação por Igreja</CardTitle>
                 <CardDescription>Distribuição da arrecadação mensal entre as igrejas da sua supervisão.</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>Distribuição de membros entre as igrejas da sua supervisão.</CardDescription>
            </CardHeader>
            <CardContent>
                <ChartContainer config={{}} className="h-[300px] w-full">
                     <PieChart>
