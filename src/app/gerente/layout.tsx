...
import { GerenteSidebar } from './_components/sidebar';
import { GerenteHeader } from './_components/header';
  ...
  return (
    <div className="grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]">
      ...
      <div className="flex flex-col">
        <GerenteHeader userName={userName} userEmail={userEmail} userFallback={userFallback} />
