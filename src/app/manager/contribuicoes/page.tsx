...
export default function ContribuicoesPage(): JSX.Element {
  ...
  const getButtonLabel = () => {
    switch (paymentMethod) {
      ...
      case 'credit_card':
        return 'Ir para o Cartão de Crédito'
      case 'boleto':
        return 'Gerar Boleto'
      default:
        return 'Continuar'
              ...
              {pixStatus === 'confirmed' && (
                <CardContent className="flex flex-col items-center justify-center p-10 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Sua contribuição de R$ {Number(amount).toFixed(2)} foi recebida com sucesso.
                  </p>
                  <Button
                    onClick={() => {
                      form.reset({
              ...
              {paymentMethod === 'boleto' && paymentDetails && (
                <Card className="bg-muted/30 flex flex-col items-center p-6">
                  <CardHeader className="items-center text-center">
                    ...
                    <CardDescription>
                      Clique no botão abaixo para baixar ou copiar o código de barras.
                    </CardDescription>
                  </CardHeader>
