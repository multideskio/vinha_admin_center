    ...
    try {
        ...
        const kpis = {
            totalContributed: {
                ...
                change: `+${newTransactionsThisMonthResult[0].value} transações este mês`
            },
            monthlyContribution: {
        ...
        return NextResponse.json({ error: "Erro ao buscar dados do dashboard da igreja", details: error.message }, { status: 500 });
    }
}
