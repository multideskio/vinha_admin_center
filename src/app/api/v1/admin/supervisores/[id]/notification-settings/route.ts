...
const notificationSettingsSchema = z.object({
  payment_notifications: z.object({ email: z.boolean(), whatsapp: z.boolean() }),
  due_date_reminders: z.object({ email: z.boolean(), whatsapp: z.boolean() }),
...
export async function GET(
  ...
  try {
    ...
    console.error('Error fetching notification settings (admin):', error)
