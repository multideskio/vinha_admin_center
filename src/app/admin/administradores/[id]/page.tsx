          ...
          <CardContent className="pt-6">
            <div className="flex flex-col items-center gap-4 py-12">
              ...
              <p className="text-muted-foreground">
                O administrador solicitado não existe ou foi removido.
              </p>
              ...
              <TabsContent value="profile">
                <Card className="shadow-lg border-t-4 border-t-videira-blue">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Atualize as informações pessoais do administrador
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Form {...form}>
                            ...
                            onCheckedChange={(checked) =>
                              setNotificationSettings((prev) => ({
                                ...
                                payment_notifications: {
                                  email: checked,
                                  whatsapp: prev.payment_notifications?.whatsapp ?? false,
                                },
                              }))
                            }
                          />
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) =>
                              setNotificationSettings((prev) => ({
                                ...prev,
                                payment_notifications: {
                                  email: prev.payment_notifications?.email ?? false,
                                  whatsapp: checked,
                                },
                              }))
                            }
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) =>
                              setNotificationSettings((prev) => ({
                                ...
                                due_date_reminders: {
                                  email: checked,
                                  whatsapp: prev.due_date_reminders?.whatsapp ?? false,
                                },
                              }))
                            }
                          />
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) =>
                              setNotificationSettings((prev) => ({
                                ...prev,
                                due_date_reminders: {
                                  email: prev.due_date_reminders?.email ?? false,
                                  whatsapp: checked,
                                },
                              }))
                            }
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) =>
                              setNotificationSettings((prev) => ({
                                ...
                                network_reports: {
                                  email: checked,
                                  whatsapp: prev.network_reports?.whatsapp ?? false,
                                },
                              }))
                            }
                          />
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) =>
                              setNotificationSettings((prev) => ({
                                ...prev,
                                network_reports: {
                                  email: prev.network_reports?.email ?? false,
                                  whatsapp: checked,
                                },
                              }))
                            }
                  ...
                  <CardContent>
                    <Alert className="mb-6 bg-destructive/10 border-destructive/30">
                      ...
                      <AlertDescription className="text-destructive">
                        ...
                        associados a este administrador serão marcados como excluídos.
                      </AlertDescription>
                    </Alert>
