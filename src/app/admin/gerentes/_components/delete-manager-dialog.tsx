...
/**
 * Dialog de confirmação de exclusão de gerente
 * Requer motivo obrigatório para auditoria
 */
export function DeleteManagerDialog({ managerId, onConfirm, children }: DeleteManagerDialogProps) {
