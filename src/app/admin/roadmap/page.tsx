  ...
  return (
    <div className="flex flex-col gap-6">
        ...
        <div className="relative z-10 p-8">
          <div>
            ...
            <p className="text-base text-white/90 mt-2 font-medium">
              Planejamento e evolução do Vinha Admin Center
            </p>
          </div>
        </div>
      </div>

      {/* Cards de Status das Versões */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="border-l-4 border-l-green-500 bg-gradient-to-br from-green-500/10 to-transparent shadow-lg hover:shadow-xl transition-all">
        ...
        <Card className="border-l-4 border-l-videira-blue bg-gradient-to-br from-videira-blue/10 to-transparent shadow-lg hover:shadow-xl transition-all">
          <CardContent className="pt-6">
            <div className="flex items-center gap-3 mb-2">
        ...
        <Card className="border-l-4 border-l-amber-500 bg-gradient-to-br from-amber-500/10 to-transparent shadow-lg hover:shadow-xl transition-all">
          <CardContent className="pt-6">
            <div className="flex items-center gap-3 mb-2">
      ...
      <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground pb-4">
        <Rocket className="h-4 w-4 text-videira-purple" />
        <span>Vinha Admin Center - Planejamento contínuo para excelência</span>
      </div>
    </div>
  )
}
