...
const WebhookFormModal = ({
  ...
  const onSubmit = async (data: Webhook) => {
    ...
    try {
      ...
      toast({
        title: 'Sucesso!',
        description: `Webhook ${webhook ? 'atualizado' : 'criado'} com sucesso.`,
        variant: 'success',
      })
      onSave()
      setIsOpen(false)
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="https://seu-servico.com/webhook" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Usado para assinar os eventos. Guarde com segurança.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
