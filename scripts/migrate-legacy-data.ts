...
const LEGACY_DATA = {
  ...
  gerentes: [
    ...
    },
    {
      ...
      sobrenome: 'Estival',
      cpf: '1',
      email: 'mauroestival@gmail.com',
    },
    { id: '12', nome: 'Almir Dias', sobrenome: 'Dias', cpf: '1', email: 'pralmirdias@gmail.com' },
    {
      id: '13',
      nome: 'Carlos Eduardo Garcez',
      sobrenome: 'Garcez',
      cpf: '1',
      email: 'pastorcarlos@vinhasc.com.br',
    },
    {
      id: '14',
      nome: 'Gilberto Camilo',
      sobrenome: 'Junior',
      cpf: '1',
      email: 'gilberto.camilo@gmail.com',
    },
    {
      id: '15',
      ...
      sobrenome: 'Guimarães',
      cpf: '1',
      email: 'pr.ricardo@videirario.com.br',
    },
    { id: '16', nome: 'Alex Martins', sobrenome: 'Silva', cpf: '1', email: 'pr.alex@hotmail.com' },
    {
      id: '17',
      nome: 'Francisco Vasco',
      sobrenome: 'Junior',
      cpf: '1',
      email: 'prfranciscovasco@gmail.com',
    },
    {
      id: '18',
      nome: 'Cristian Gimenez',
      sobrenome: 'Gimenez',
      cpf: '1',
      email: 'prcristiangimenez@gmail.com',
    },
    {
      id: '19',
      nome: 'Hermes Pereira',
  ...
  supervisores: [
    {
      id: '10',
      nome: 'Wendell Clayton',
      sobrenome: 'Antunes da Silva',
      gerente: 'Naor Pedroza',
      regiao: 'CENTRO OESTE',
      cpf: '1',
      email: 'prwendellclayton@gmail.com',
    },
    {
      id: '50',
      nome: 'Abel Rodrigo',
      sobrenome: 'M. Chaveiro',
      gerente: 'Abel Rodrigo',
      regiao: 'CENTRO OESTE',
      cpf: '1',
      email: 'pastorabelrodrigo@gmail.com',
    },
    {
      id: '69',
      nome: 'Aluízio',
      sobrenome: 'Antônio da Silva',
      gerente: 'Aluízio',
      regiao: 'CENTRO OESTE',
      cpf: '34764569191',
      email: 'dizimosvinha@gmail.com',
    },
    {
      id: '85',
      nome: 'Guilherme Libório',
      sobrenome: 'Miranda',
      gerente: 'Cristian Gimenez',
      regiao: 'CENTRO OESTE',
      cpf: '01360245138',
      email: 'prguilhermeliborio@gmail.com',
    },
    {
      id: '86',
      nome: 'Alisson Rafael',
      ...
      regiao: 'CENTRO OESTE',
      cpf: '01975115112',
      email: 'Alissonrafael3003@gmail.com',
    },
    {
      id: '18',
      nome: 'Mauro Estival',
      sobrenome: 'Estival',
      gerente: 'Mauro Estival',
      regiao: 'NORTE',
      cpf: '1',
      email: 'mauroestival@gmail.com',
    },
    {
      ...
      regiao: 'NORTE',
      cpf: '1',
      email: 'pralmirdias@gmail.com',
    },
    {
      id: '23',
      nome: 'Alex Martins',
      sobrenome: 'Silva',
      gerente: 'Alex Martins',
      regiao: 'NORTE',
      cpf: '1',
      email: 'pr.alexmartins@hotmail.com',
    },
    {
      id: '28',
      nome: 'Paulo Alves',
      ...
      regiao: 'NORTE',
      cpf: '1',
      email: 'apostolo12paulo@gmail.com',
    },
    {
      id: '29',
      nome: 'Ricardo Augusto',
      sobrenome: 'Martins Barbosa',
      gerente: 'Alain Davidson',
      regiao: 'NORTE',
      cpf: '1',
      email: 'pastor.ricardoaugusto@gmail.com',
    },
  ],
}
...
async function migrateRegions(companyId: string) {
  ...
  for (const i = 0; i < LEGACY_DATA.regioes.length; i++) {
